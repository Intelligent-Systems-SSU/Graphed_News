...
from . import NewsSummary_pb2 as NewsSummary__pb2
...
class NewsSummaryServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_NewsSummaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'NewsSummary', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('NewsSummary', rpc_method_handlers)
